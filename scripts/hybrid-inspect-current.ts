...
async function main() {
  ...
  const output: Record<string, unknown> = {
    ...
    channels: { timingChannel: snapshot.hybrid.timingChannel, cyclePressureChannel: snapshot.hybrid.cyclePressureChannel, cyclePressureMethod: snapshot.hybrid.cyclePressureMethod, cyclePressureHorizonCoverage: snapshot.hybrid.cyclePressureHorizonCoverage, policyTimingChannel: snapshot.hybrid.policyTimingChannel, strongestSignalChannel: snapshot.hybrid.strongestSignalChannel, negativePenalty: snapshot.hybrid.negativePenalty, maxWinningChannel: snapshot.hybrid.maxWinningChannel, finalWatchScore: snapshot.hybrid.watchScore, appliedOverride: snapshot.hybrid.appliedOverride },
