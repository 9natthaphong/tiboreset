...
export default function AdvancedDiagnostics({ forecast }: { forecast: Forecast }) {
  ...
  return <div className="advanced-diagnostics-content">
    ...
    <div className="coefficient-table" role="table" aria-label="Forecast coefficients"><div role="row"><b>Display label</b><b>Technical feature</b><b>Origin</b><b>Value</b><b>Coefficient</b><b>Contribution</b></div>{forecast.contributions.map(item => {
